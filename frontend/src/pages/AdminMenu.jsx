...
const AdminMenuPage = () => {
    ...
    const handleAddOrUpdate = async (e) => {
        ...
        try {
            if (editDay) {
                await axios.put(`https://messmate-luwo.onrender.com/api/menu/update/${editDay}`, formData, { withCredentials: true });
                toast.success("Menu updated successfully");
            } else {
                await axios.post("https://messmate-luwo.onrender.com/api/menu/add", formData, { withCredentials: true });
    ...
    const handleDelete = async (day) => {
        try {
            await axios.delete(`https://messmate-luwo.onrender.com/api/menu/delete/${day}`, { withCredentials: true });
