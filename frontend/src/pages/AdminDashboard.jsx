...
const AdminDashboard = () => {
  ...
  const fetchStats = async () => {
    try {
      const res = await axios.get('https://messmate-luwo.onrender.com/api/user/stats', {
  ...
  const handleLogout = async () => {
    try {
      await axios.post(
        'https://messmate-luwo.onrender.com/api/user/logout',
        {},
        { withCredentials: true }
      );
  ...
  const handleMarkAllAttendance = async () => {
    try {
      ...
      const res = await axios.post(
        'https://messmate-luwo.onrender.com/api/attendance/mark-all',
        { date: today },
        { withCredentials: true }
      );
