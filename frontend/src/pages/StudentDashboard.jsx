...
const StudentDashboard = () => {
  ...
  const fetchBill = async () => {
    try {
      const response = await axios.get(`https://messmate-luwo.onrender.com/api/attendance/bill`, {
  ...
  const handleLogout = async () => {
    try {
      await axios.post('https://messmate-luwo.onrender.com/api/user/logout', {}, {
        withCredentials: true,
      });
  ...
  const handlePay = async () => {
    try {
      const res = await axios.post(
        "https://messmate-luwo.onrender.com/api/payments/create-order",
  ...
  const verifyPayment = async (response, order) => {
    try {
      const verifyRes = await axios.post(
        "https://messmate-luwo.onrender.com/api/payments/verify-payment",
        {
