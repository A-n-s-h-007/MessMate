...
const AdminNotice = () => {
  ...
  const fetchNotices = async () => {
    setLoading(true);
    try {
      const res = await axios.get("https://messmate-luwo.onrender.com/api/notice/all", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        // Update
        await axios.put(
          `https://messmate-luwo.onrender.com/api/notice/update/${editingId}`,
          form,
          { withCredentials: true }
        );
        ...
        // Create
        await axios.post(
          "https://messmate-luwo.onrender.com/api/notice/create",
          form,
          { withCredentials: true }
        );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://messmate-luwo.onrender.com/api/notice/delete/${id}`, {
        withCredentials: true,
      });
